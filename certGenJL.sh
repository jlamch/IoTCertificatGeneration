...
openssl_intermediate_config_file="./openssl_device_jl_intermediate_ca.cnf"
intermediate_ca_password="jl5678"
intermediate_ca_prefix="azure-iot-jl.intermediate"
...
{
    local common_name="IoT Hub Intermediate CA JL"
